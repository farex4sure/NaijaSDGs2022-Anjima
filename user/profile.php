                ...
                <div class='flex flex-col w-full gap-3 px-3 py-4 rounded-lg'>
                    <div class="flex flex-col items-center bg-white bg-opacity-50 py-8 px-3 rounded-xl">
                        <div class="flex justify-center items-center py-4">
                            <div class="flex justify-center items-center rounded-full text-2xl md:text-3xl w-16 h-16 bg-teal-600 text-teal-50">
                                <img class="rounded-full object-cover h-full w-full" src="images/<?php echo $pic ?>" alt="user_photo">
                            </div>
                        </div>
                        <div class="flex flex-col w-full items-center gap-4 pt-2 pb-4">
                            <span class="block w-full text-center text-gray-400 border-b pb-2">Hi, <span class="uppercase font-semibold"><?php echo $name ?></span></span>
                            <div class='flex items-center justify-between w-full'>
                                <div class="flex flex-col">
                                    <span class='text-xs text-gray-600'>Anjima Account Number</span>
                                    <span class='font-semibold'><?php echo $_SESSION['loggedin_user'] ?> <i class='fa fa-copy text-gray-400'></i></span>
                                </div>
                                <a href="qr.php" class="flex flex-col">
                                    <span class='text-xs text-gray-600'>Payment QR code</span>
                                    <span class='font-semibold'><i class='fa fa-qrcode'></i></span>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class='flex flex-col divide-y border-t border-b rounded-md justify-start bg-white bg-opacity-50 py-2'>
                        ...
                        <div class='flex items-center justify-between w-full py-3 px-3'>
                            ...
                            <div class='flex justify-end items-center text-sm text-gray-500'>
                                <span class="truncate"><?php echo $_SESSION['loggedin_user'] ?></span>
                            </div>
                        </div>
                        <div class='flex items-center justify-between w-full py-3 px-3'>
                            <div class='flex items-center justify-center'>
