        ...
        <div class="flex flex-col px-4 w-full h-full items-center pb-8 bg-black bg-opacity-50">
            ...
            <div class="flex justify-center w-full">
                <div class="flex w-full max-w-xs justify-between">
                    <a href="signin.php" class="inline-flex items-center py-2 px-4 text-md font-medium text-center text-white    rounded-lg hover:bg-teal-600 focus:ring-4 focus:outline-none focus:ring-teal-300 dark: dark:hover:bg-teal-600 dark:focus:ring-teal-800"><i class="fa-solid fa-arrow-right-to-bracket pr-2"></i>Sign in</a>
