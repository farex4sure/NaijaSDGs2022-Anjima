            ...
            <div class='flex items-center w-full max-w-6xl'>
                <div class='flex items-center gap-2 mr-auto'>
                    <div class='flex items-center gap-4'>
                        ...
                        <h3 class='w-full text-sm md:text-lg font-semibold text-gray-600'>Withdraw</h3>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class='flex flex-col'>
                    <div class="flex flex-col mt-5">
                        <form>
                            ...
                            <button type="submit" class="text-white bg-teal-600 hover:bg-teal-700 focus:ring-4 focus:outline-none focus:ring-teal-300                                   font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">
                            Next
                            </button>
                        </form>
                    </div>
