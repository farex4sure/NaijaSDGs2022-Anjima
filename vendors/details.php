...
<body>
    <div class='h-screen flex flex-col items-center bg-gradient-to-r from-teal-900 to-sky-900 font-bold bg-no-repeat bg-cover' style='background-image: url(data:image/jpeg;base64,);'>
        ...
        <?php echo $err ?>
            <form action="details.php" method="post" class='h-full flex flex-col'>
                <div class="mb-6 md:mb-8">
                    <div class='flex items-center mb-2'>
                        <label for="name" class="block text-sm font-medium text-gray-600 mr-auto">Full Name</label>
                    </div>
                    <input type="text" name="fullname" class="bg-gray-50 border-b-2 border-gray-300 text-gray-900 text-sm md:text-lg font-light focus:outline-none focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 md:py-4" placeholder="Your Name" required="">
                </div>
                <div class="mb-4 md:mb-8">
                    <div class='flex items-center mb-2'>
                        <label for="category" class="block text-sm font-medium text-gray-600 mr-auto">Category</label>
                    </div>
                    <select name="category" class="bg-gray-50 border-b-2 border-gray-300 text-gray-900 text-sm md:text-lg font-light focus:outline-none focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 md:py-4">
                ...
                <div class="mb-4 md:mb-8">
                    ...
                    <input type="password" name="password" class="bg-gray-50 border-b-2 border-gray-300 text-gray-900 text-sm md:text-lg font-light focus:outline-none focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 md:py-4" minlength="8" placeholder="Create a new password" required="">
                </div>
                <div class="mb-auto md:mb-8">
                    ...
                    <input type="password" name="confirm-password" class="bg-gray-50 border-b-2 border-gray-300 text-gray-900 text-sm md:text-lg font-light focus:outline-none focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 md:py-4" minlength="8" placeholder="Confirm password" required="">
                </div>
                <div class="flex w-full md:justify-center mb-2">
                    <button type="submit" name="submit" class="text-white max-w-xl w-full bg-teal-600 hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm md:text-lg px-5 py-2.5 md:p-4 text-center">Continue</button>
                </div>
            </form>
        </div>
    </div>
